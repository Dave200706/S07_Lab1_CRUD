    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId =3, Name = "David's Weapon", Description= "The most powerful weapon in history", Force = 1000, Image= "https://publicdomainvectors.org/photos/Shield-ClassicMedieval1.png", Price = 1, Qty=1, QtyBought=1,CreatedDate= new DateTime(2026,01,01) }
                );
            #endregion
        }
    }
